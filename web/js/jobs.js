    ...
    return `
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fieldOfStudy" name="fieldOfStudy" placeholder="e.g., Computer Science, Engineering">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="skills" name="skills" placeholder="e.g., JavaScript, Python, React, Node.js, MongoDB" required>
            </div>
            <div class="form-group">
                <label for="softSkills">Soft Skills (comma-separated)</label>
                <input type="text" id="softSkills" name="softSkills" placeholder="e.g., Leadership, Communication, Problem Solving">
            </div>
            <div class="form-group">
